...
<p class="<!--tit-->" id="<!--wt--!>">Watched <!--Edited by Sai over-->
 <!--Commented by Sai <i id="wti" class="fa fa-angle-double-up" style="font-size:16px;float:right;padding-right:5px;">
                   ...
                   --!>
                   <div id="wtdiv">
                       <input type="radio" name="watchlist" value="1">Yes
                       <input type="radio" name="watchlist" value="0" >NO
                        <input type="radio"  name="watchlist"  checked="checked"  value="undefined" style="margin-left:15px;">Both
                   ...
                   --!>
                   <div id="radiv">
                      <p class="eamrank"><input type="checkbox" name='rank' value="1-10000">1-10000</input></p>
<p class="eamrank"><input type="checkbox" name='rank' value="10001-20000">10001-20000</input></p>
<p class="eamrank"><input type="checkbox" name='rank' value="20000-30000">20000-30000</input></p>
<p class="eamrank"><input type="checkbox"  value="30000-40000" name='rank'>30000-40000</input></p>
<p class="eamrank"><input type="checkbox" value="40000 and above" name='rank'>40000 and above</input></p>
...
$(".fa-angle-double-down").hide();
        ...
        $("#co").click(function(){
            $("#co").find(".fa-angle-double-down, .fa-angle-double-up").toggle();
            $("#codiv").toggle();
        });
        $("#to").click(function(){
            $("#to").find(".fa-angle-double-down, .fa-angle-double-up").toggle();
            $("#todiv").toggle();
        });
        $("#ac").click(function(){
            $("#ac").find(".fa-angle-double-down, .fa-angle-double-up").toggle();
            $("#acdiv").toggle();
        });
        $("#gr").click(function(){
            $("#gr").find(".fa-angle-double-down, .fa-angle-double-up").toggle();
            $("#grdiv").toggle();
        });
        $("#wt").click(function(){
            $("#wt").find(".fa-angle-double-down, .fa-angle-double-up").toggle();
            $("#wtdiv").toggle();
        });
        $("#ra").click(function(){
            $("#ra").find(".fa-angle-double-down, .fa-angle-double-up").toggle();
            $("#radiv").toggle();
        });
        $("#de").click(function(){
            $("#de").find(".fa-angle-double-down, .fa-angle-double-up").toggle();
            $("#dediv").toggle();
        });
        $("#se").click(function(){
            $("#se").find(".fa-angle-double-down, .fa-angle-double-up").toggle();
            $("#sediv").toggle();
        });
