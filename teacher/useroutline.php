...
$PAGE->set_url('/teacher/useroutline.php', array('id'=>$userid, 'course'=>$courseid, 'mode'=>$mode));
...
$navigationnode = array(
        'url' => new moodle_url('/teacher/useroutline.php', array('id' => $user->id, 'course' => $course->id, 'mode' => $mode))
    );
if ($mode === 'complete') {
