...
<h3>Today's Tests</h3>
END;
$html=html_writer::start_tag('input',array('type'=>'button','class'=>'refresh1','value'=>'Refresh',
'data-url'=> $CFG->wwwroot . '/student/getactivetests.php'));
echo $html;
print <<<END
      <div id="accordion1" style="width:100%">
 <div id="taccordion" style="width:100%">
END;
...
AND `userid` ='$USER->id'");
                        ...
                        if ($grade >=0)
                    {
                            ...
                            $pre_result.= $grade+0;
 $pre_result.=" <b> ( ". count($attempts)." Attempts ) ";
...
ORDER BY `grade` DESC ");
 ...
 $pre_result.=" (".count($submissions)."Submissions)";
                          $pre_result.= html_writer::end_tag('td');
