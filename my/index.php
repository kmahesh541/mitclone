...
if (user_has_role_assignment($USER->id, 3)){
    $url = new moodle_url('/teacher/dashboard.php');
echo redirect($url);
}
//student block
...
/*login status storing in a tables*/
    ...
    $url = new moodle_url('/student/dashboard.php');
echo redirect($url);
}
//echo "<div style='height:420px'><h1>User Is a Student</h1></div>";
else {
    echo $OUTPUT->header();
