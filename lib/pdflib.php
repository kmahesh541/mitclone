...
class pdf extends TCPDF {
    ...
    //Page header for setting logo
    /*public function Header() {
        // Logo
        //$image_file = K_PATH_IMAGES.'logo.png';

$this->writeHTML('<style>div.pdfhead{font-family: "Open Sans","Trebuchet MS",arial,verdana,sans-serif !important;color: #C14800; font-weight: bold; font-size: 16px; padding-bottom: 0px ! important; margin-bottom: 0px ! important;height: 175px !important;}</style><div class="pdfhead"><span style="padding:20px !important;">TESSELLATOR</span></div>
');
        $style = array('width' => 0.5, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(154, 43, 0));

        $this->Line(10, 15, 200, 15, $style);
        //$this->Image($image_file, 15, 5, 30, '15', 'PNG', '', 'T', false, 200, '', false, false, 0, false, false, false);
        // Set font
       // $this->SetFont('helvetica', 'B', 20);
        // Title
       // $this->Cell(0, 15, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }*/
//Page Footer for setting logo
    public function Footer() {
        Global $USER;
        // Logo
        //$image_file = K_PATH_IMAGES.'logo.png';
        $pdfcreator='Created by '.$USER->firstname.' on '.userdate(time());
      //  $this->writeHTML($pdfcreator);
        $cur_y = $this->y;
        $this->SetTextColorArray(193,72,0);
        ...
        $this->SetY($cur_y);
        $this->Cell(0, 0, $pdfcreator, 'T', 0, 'L');
        //Print page number
        if ($this->getRTL()) {
