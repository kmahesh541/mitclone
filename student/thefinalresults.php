...
$pre_result.= html_writer::start_tag('td');
                       ...
                       $pre_result.=sizeof($submissions);
                        $pre_result.= html_writer::end_tag('td');
                        printdataact($ar1,'Lab',$activitytype,$descact,$usergrade,$attempts);
...
<div class="span10 ">
<div class="span12 sss">
<div class="span8 sss testinfo">
<p class="hea">
END;
    echo $activity_name;
    print <<<END
...
END;
 ...
 <div class="span2 sss3 testres">
 <a class="te1 btn btn-primary btn-lg pull-right" value="submit">
 Submissions<br>
END;
    echo $no_of_submission;
 print <<<END
    </a><a class="te2 btn btn-primary btn-lg pull-right" value="submit">
 Grade<br><span>
END;
    echo $act_grade;
 print<<<END
 </span></a></div></div></div></div><div class="span2 taketes">
 </div>
 </div>
